...
_lr_productions = [
  ...
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calc.py',89),
  ('expression -> INT','expression',1,'p_expression_int_float','calc.py',95),
  ('expression -> FLOAT','expression',1,'p_expression_int_float','calc.py',96),
  ('expression -> NAME','expression',1,'p_expression_var','calc.py',102),
  ('empty -> <empty>','empty',0,'p_empty','calc.py',111),
]
